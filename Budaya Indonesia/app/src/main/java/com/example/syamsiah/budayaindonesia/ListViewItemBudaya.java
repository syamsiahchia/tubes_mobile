package com.example.syamsiah.budayaindonesia;
...
public class ListViewItemBudaya  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] values = new String[]{"DKI Jakarta", "Aceh",
                "Bali", "Sulawesi Barat","Sulawesi Tenggara",
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position == 3) {
                    Intent myIntent = new Intent(view.getContext(), Sulawesi_barat.class);
                    startActivityForResult(myIntent, 0);
                }

                if (position == 4) {
                    Intent myIntent = new Intent(view.getContext(), Sulawesi_Tenggara.class);
                    startActivityForResult(myIntent, 0);
                }

                if (position == 5) {
                    Intent myIntent = new Intent(view.getContext(), Sulawesi_utara.class);
                    startActivityForResult(myIntent, 0);
                }
